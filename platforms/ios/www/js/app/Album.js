    ...
    levels: [
        {
            ...
            name: 'ステージ１',
            pictures: [
                { id: 100, name: 'ロナウド', category: CQ.Album.Category.Sports, answers: [] },
                { id: 101, name: '通天閣', category: CQ.Album.Category.Building, answers: [] },
                { id: 102, name: 'ワンピース', category: CQ.Album.Category.Animation, answers: [] },
                { id: 103, name: 'ジョーダン', category: CQ.Album.Category.Sports, answers: [] },
                { id: 104, name: 'シドニー', category: CQ.Album.Category.Geography, answers: [] },
                { id: 105, name: 'スーパーマリオ', category: CQ.Album.Category.Game, answers: [] },
                { id: 106, name: 'SMAP', category: CQ.Album.Category.Entertainer, answers: [] },
                { id: 107, name: 'アバター', category: CQ.Album.Category.Film, answers: [] },
                { id: 108, name: 'CHANEL', category: CQ.Album.Category.Brand, answers: [] },
                { id: 109, name: 'FACEBOOK', category: CQ.Album.Category.Brand, answers: [] },
                { id: 110, name: 'ジョブズ', category: CQ.Album.Category.Celebrity, answers: [] },
                { id: 111, name: 'オバマ', category: CQ.Album.Category.Celebrity, answers: [] },
        ...
        },
        {
            ...
            name: 'ステージ２',
            pictures: [
                { id: 200, name: 'ガンダム', category: CQ.Album.Category.Animation, answers: [] },
                { id: 201, name: 'YAHOO', category: CQ.Album.Category.Brand, answers: [] },
                { id: 202, name: 'スターバックス', category: CQ.Album.Category.Brand, answers: [] },
                { id: 203, name: 'アマゾン', category: CQ.Album.Category.Brand, answers: [] },
                ...
                { id: 211, name: 'アンダーワールド', category: CQ.Album.Category.Film, answers: [] },
                { id: 212, name: 'ポケモン', category: CQ.Album.Category.Game, answers: [] },
                { id: 213, name: 'ロンドン', category: CQ.Album.Category.Geography, answers: [] },
                ...
                { id: 217, name: 'ブラジル', category: CQ.Album.Category.Geography, answers: [] },
        ...
        },
        {
            ...
            pictures: [
                ...
                { id: 301, name: 'モスバーガー', category: CQ.Album.Category.Brand, answers: [] },
                { id: 302, name: 'ドラえもん', category: CQ.Album.Category.Cartoon, answers: [] },
                { id: 303, name: 'ソフトバンク犬', category: CQ.Album.Category.Brand, answers: [] },
                { id: 304, name: 'LV', category: CQ.Album.Category.Brand, answers: [] },
                { id: 305, name: 'サウスパーク', category: CQ.Album.Category.Animation, answers: [] },
                { id: 306, name: 'アイアンマン', category: CQ.Album.Category.Film, answers: [] },
                { id: 307, name: 'BMW', category: CQ.Album.Category.Brand, answers: [] },
                { id: 308, name: '忍者タートルズ', category: CQ.Album.Category.Animation, answers: [] },
                { id: 309, name: 'キャデラック', category: CQ.Album.Category.Brand, answers: [] },
                { id: 310, name: 'ユベントス', category: CQ.Album.Category.Sports, answers: [] },
                { id: 311, name: 'アイスエイジ', category: CQ.Album.Category.Film, answers: [] },
                { id: 312, name: 'ビルゲイツ', category: CQ.Album.Category.Celebrity, answers: [] },
                { id: 313, name: 'ヴェネツィア', category: CQ.Album.Category.Geography, answers: [] },
                { id: 314, name: 'インセプション', category: CQ.Album.Category.Film, answers: [] },
                { id: 315, name: 'マツコデラックス', category: CQ.Album.Category.Entertainer, answers: [] },
                { id: 316, name: 'マクドナルド', category: CQ.Album.Category.Brand, answers: [] },
                { id: 317, name: 'バルセロナ', category: CQ.Album.Category.Geography, answers: [] },
                { id: 318, name: 'バーミヤン', category: CQ.Album.Category.Brand, answers: [] },
        ...
        },
        {
            ...
            pictures: [
                ...
                { id: 402, name: 'ちびまる子ちゃん', category: CQ.Album.Category.Animation, answers: [] },
                { id: 403, name: '野口英世', category: CQ.Album.Category.History, answers: [] },
                { id: 404, name: 'ハーゲンダッツ', category: CQ.Album.Category.Brand, answers: [] },
                { id: 405, name: 'ローマ', category: CQ.Album.Category.Geography, answers: [] },
                { id: 406, name: 'LOST', category: CQ.Album.Category.Series, answers: [] },
                { id: 407, name: 'フォレストガンプ', category: CQ.Album.Category.Film, answers: [] },
                ...
                { id: 415, name: 'キングコング', category: CQ.Album.Category.Film, answers: [] },
                { id: 416, name: 'オニール', category: CQ.Album.Category.Sports, answers: [] },
                { id: 417, name: 'リオデジャネイロ', category: CQ.Album.Category.Geography, answers: [] },
                { id: 418, name: 'デビッドベッカム', category: CQ.Album.Category.Sports, answers: [] },
        ...
        },
        {
            ...
            pictures: [
                ...
                { id: 502, name: 'マラドーナ', category: CQ.Album.Category.Sports, answers: [] },
                { id: 503, name: 'アングリーバード', category: CQ.Album.Category.Game, answers: [] },
                { id: 504, name: 'サブウェイ', category: CQ.Album.Category.Brand, answers: [] },
                { id: 505, name: 'スタートレック', category: CQ.Album.Category.Film, answers: [] },
                { id: 506, name: 'フレンズ', category: CQ.Album.Category.Series, answers: [] },
                { id: 507, name: 'アルゼンチン', category: CQ.Album.Category.Geography, answers: [] },
                { id: 508, name: 'シュレック', category: CQ.Album.Category.Film, answers: [] },
                { id: 509, name: 'イエス', category: CQ.Album.Category.Celebrity, answers: [] },
                { id: 510, name: 'グラディエーター', category: CQ.Album.Category.Film, answers: [] },
                { id: 511, name: 'チリ', category: CQ.Album.Category.Geography, answers: [] },
                { id: 512, name: 'マダガスカル', category: CQ.Album.Category.Film, answers: [] },
                { id: 513, name: 'ドバイ', category: CQ.Album.Category.Geography, answers: [] },
                { id: 514, name: '豐臣秀吉', category: CQ.Album.Category.History, answers: [] },
                { id: 515, name: 'AMEBA', category: CQ.Album.Category.Brand, answers: [] },
                { id: 516, name: 'プレスリー', category: CQ.Album.Category.Celebrity, answers: [] },
                { id: 517, name: 'ロールスロイス', category: CQ.Album.Category.Brand, answers: [] },
                { id: 518, name: 'COCO壱番屋', category: CQ.Album.Category.Brand, answers: [] },
                { id: 519, name: 'ブッシュ', category: CQ.Album.Category.Celebrity, answers: [] }
            ]
        },
        {
            level: 6,
            name: 'ステージ６',
            pictures: [
                { id: 600, name: 'グリコ', category: CQ.Album.Category.Brand, answers: [] },
                ...
                { id: 603, name: 'ホーキング', category: CQ.Album.Category.Celebrity, answers: [] },
                { id: 604, name: '丸井', category: CQ.Album.Category.Brand, answers: [] },
                { id: 605, name: '英国王のスピーチ', category: CQ.Album.Category.Film, answers: [] },
                ...
                { id: 610, name: 'プリングス', category: CQ.Album.Category.Brand, answers: [] },
                ...
                { id: 615, name: 'ガリレオ', category: CQ.Album.Category.Series, answers: [] },
                { id: 616, name: '広島東洋カープ', category: CQ.Album.Category.Sports, answers: [] },
                { id: 617, name: '白い恋人', category: CQ.Album.Category.Brand, answers: [] },
                { id: 618, name: 'ゴジラ', category: CQ.Album.Category.Film, answers: [] },
                { id: 619, name: 'インド', category: CQ.Album.Category.Geography, answers: [] }
            ]
        }
    ]
};
